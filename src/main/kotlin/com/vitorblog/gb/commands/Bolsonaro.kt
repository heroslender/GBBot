...
class Bolsonaro : CMD {
    ...
    val msgs = arrayListOf("Benino veste azul Benina veste rosa", "Tem que se fude e acabo", "Skripter bom é skripter banido", "Se tem tinta na frente já sei que laga", "taokey", "$taokey")
